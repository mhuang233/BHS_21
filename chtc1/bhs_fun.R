...
alz <- function(rep, c, ni, nj, sd, df, model_strings, var_names){
  ...
  #save(ws, klds, file = paste0(rep, "_", c, "_", ni, "_", nj, "_", sd, "_out.RData"))
  ...
  print(paste0("rep_", rep, "_seed", c, "_", ni, "_", nj, "_sd", sd, "_sigma", sigma, "_ws"))
  ...
  save(list = c(paste0("rep_", rep, "_seed", c, "_", ni, "_", nj, "_sd", sd, "_sigma", sigma, "_ws"), 
                ...
                paste0("rep_", rep, "_seed", c, "_", ni, "_", nj, "_sd", sd, "_sigma", sigma, "_time")),
       file = paste0("rep_", rep, "_seed", c, "_", ni, "_", nj, "_sd", sd, "_sigma", sigma, "_out.RData"))
  
  #file_path <- paste0("rep_", rep, "_seed", c, "_", ni, "_", nj, "_sd", sd, "_sigma", sigma, "_out.RData")

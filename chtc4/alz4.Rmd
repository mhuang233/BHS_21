...
colnames(time_mean) <- c("sd", "N", "time_mean")
...
```{r}
# sigma = 0
a <- alz(ni = 50, nj = 10, sd = 0.033, sigma = 0)
b <- alz(ni = 150, nj = 30, sd = 0.033, sigma = 0)

c <- alz(ni = 50, nj = 10, sd = 0.041, sigma = 0)
d <- alz(ni = 150, nj = 30, sd = 0.041, sigma = 0)

e <- alz(ni = 50, nj = 10, sd = 0.1, sigma = 0)
f <- alz(ni = 150, nj = 30, sd = 0.1, sigma = 0)
...
```{r}
# sigma = 5
m <- alz(ni = 50, nj = 10, sd = 3.333, sigma = 10)
n <- alz(ni = 150, nj = 30, sd = 3.333, sigma = 10)

o <- alz(ni = 50, nj = 10, sd = 4.082, sigma = 10)
p <- alz(ni = 150, nj = 30, sd = 4.082, sigma = 10)

q <- alz(ni = 50, nj = 10, sd = 10, sigma = 10)
r <- alz(ni = 150, nj = 30, sd = 10, sigma = 10)
```
...
p1 <- ws_sigma0 %>% ggplot() +
  ...
  facet_grid(N~sd, labeller = label_both) + 
...
```
## in case they want black and white
```{r}
ws_sigma0 %>% ggplot() +

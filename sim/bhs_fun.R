...
alz <- function(rep, c, ni, nj, icc, df1, df2, model_strings, var_names){
  ...
  #save(ws, klds, file = paste0(rep, "_", c, "_", ni, "_", nj, "_", icc, "_out.RData"))
  
  assign(paste0("rep_", rep, "_seed", c, "_", ni, "_", nj, "_icc", icc, "_sigma", sigma, "_ws"), ws)
